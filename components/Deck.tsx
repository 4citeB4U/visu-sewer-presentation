...
const renderContent = (section: DeckSection) => {
    switch (section.content.type) {
        ...
        case 'summary':
                    ...
                    <div className="p-6 md:p-8 h-full flex flex-col justify-center">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                            ...
                            <div className="order-2 md:order-1">
                                ...
                                <p className="text-lg text-gray-700 mb-6" dangerouslySetInnerHTML={{ __html: section.narrative }}></p>
            ...
            return (
                <div className="p-6 md:p-8 h-full flex flex-col justify-center">
                    <h2 className="text-3xl font-bold text-gray-800 mb-4 text-center">{section.title}</h2>
                    <p className="text-lg text-gray-700 mb-6 max-w-4xl mx-auto text-center" dangerouslySetInnerHTML={{ __html: section.narrative }}></p>
